...
namespace Game.Scripts.Logic
{
    public class LevelView : MonoBehaviour
    {
        ...
        [Header("WaitModeViews")]
        [SerializeField] private WaitModeView[] waitModeViews;
        [Header("LevelChangeModeView")]
        [SerializeField] private LevelChangeModeView[] levelChangeModeViews;
